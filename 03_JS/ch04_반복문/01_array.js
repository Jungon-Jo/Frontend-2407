...
let personObj = {
  name: 'James', age: 27, gender: '남자', job: '프로그래머', height: 175.3, favoriteFruits: ['수박', '포도']
}
console.log(personObj)

// 배열 요소 추가
summerFruits.push('자두');
console.log(summerFruits);        // 제일 마지막 element 뒤로 추가된다.

// 배열 요소 제거
summerFruits.splice(2, 1);       // 인덱스가 2인 element부터 1개를 제거
console.log(summerFruits)